...
namespace HKCBusbarInspection.UI.Form
{
    public partial class Login : XtraForm
    {
        ...
        private class LocalizationLogin
        {
            private enum Items
            {
                [Translation("User Authentication", "사용자 인증")]
                타이틀,
                [Translation("Login", "로그인")]
                로그인,
                [Translation("User", "사용자명")]
                사용자명,
                [Translation("Password", "비밀번호")]
                비밀번호,
                [Translation("Username or password is incorrect.", "사용자명 또는 비밀번호가 올바르지 않습니다.")]
                인증오류,
            }
