...
namespace HKCBusbarInspection.Schemas
{
    public class BUSBAR3D : Viewport
    {
        ...
        private void NEG3PModel()
        {
            ...
            InspItems.Add(new Label3D(검사항목.좌상홀가로기준치수) { Point = new Point3D(standardX, standardY + 46 * Scale, fz), Origin = new Point3D(standardX - 125, standardY + 43 * Scale, tz), Name = "좌상홀가로위치도", LabelStyle = NamePrintType.Up, FontHeight = 10 });
            InspItems.Add(new Label3D(검사항목.좌중홀가로기준치수) { Point = new Point3D(standardX, standardY + 20.5 * Scale, fz), Origin = new Point3D(standardX - 125, standardY + 17.5 * Scale, tz), Name = "좌중홀가로위치도", LabelStyle = NamePrintType.Up, FontHeight = 10 });
            ...
            InspItems.Add(new Label3D(검사항목.좌상홀세로기준치수) { Point = new Point3D(standardX, standardY + 46 * Scale, fz), Origin = new Point3D(standardX - 125, standardY + 39 * Scale, tz), Name = "좌상홀세로위치도", LabelStyle = NamePrintType.Up, FontHeight = 10 });
            InspItems.Add(new Label3D(검사항목.좌중홀세로기준치수) { Point = new Point3D(standardX, standardY + 20.5 * Scale, fz), Origin = new Point3D(standardX - 125, standardY + 13.5 * Scale, tz), Name = "좌중홀세로위치도", LabelStyle = NamePrintType.Up, FontHeight = 10 });
            ...
            InspItems.Add(new Label3D(검사항목.우상홀가로기준치수) { Point = new Point3D(standardX + 9.63 * Scale, standardY + 46 * Scale, fz), Origin = new Point3D(standardX + 125, standardY + 43 * Scale, tz), Name = "우상홀가로위치도", LabelStyle = NamePrintType.Up, FontHeight = 10 });
            InspItems.Add(new Label3D(검사항목.우중홀가로기준치수) { Point = new Point3D(standardX + 9.63 * Scale, standardY + 20.5 * Scale, fz), Origin = new Point3D(standardX + 125, standardY + 17.5 * Scale, tz), Name = "우중홀가로위치도", LabelStyle = NamePrintType.Up, FontHeight = 10 });
            ...
            InspItems.Add(new Label3D(검사항목.우상홀세로기준치수) { Point = new Point3D(standardX + 9.63 * Scale, standardY + 46 * Scale, fz), Origin = new Point3D(standardX + 125, standardY + 39 * Scale, tz), Name = "우상홀세로위치도", LabelStyle = NamePrintType.Up, FontHeight = 10 });
            InspItems.Add(new Label3D(검사항목.우중홀세로기준치수) { Point = new Point3D(standardX + 9.63 * Scale, standardY + 20.5 * Scale, fz), Origin = new Point3D(standardX + 125, standardY + 13.5 * Scale, tz), Name = "우중홀세로위치도", LabelStyle = NamePrintType.Up, FontHeight = 10 });
